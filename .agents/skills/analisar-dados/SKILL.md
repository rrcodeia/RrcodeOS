...
- **Contexto do negócio:** `.agents/rules/empresa.md` (pra entender o que os dados representam)
- **Tom de voz:** `.agents/rules/preferencias.md`
...
- Tom conforme `.agents/rules/preferencias.md`
