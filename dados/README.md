...
Solte aqui qualquer arquivo que você quer que o RrcodeOS leia uma vez: CSV
...
artefato em `.agents/rules/`, `marketing/` ou `saidas/`.

Quando você tiver MCPs de armazenamento conectados (Google Drive,
Notion), pode pedir pro Gemini buscar os arquivos direto da fonte — sem
