...
> Skills locais ficam em `.gemini/commands/` e so funcionam nesse projeto.
...
**Fonte:** Skill validada pelo RrcodeOS
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/frontend-design`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/canvas-design`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/pdf`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/docx`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/pptx`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/xlsx`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/doc-coauthoring`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/webapp-testing`
**Fonte:** Skill nativa do Gemini Antigravity
...
**Como instalar:** Ja vem nativo no Gemini Antigravity. Chamar com `/skill-creator`
**Fonte:** Skill nativa do Gemini Antigravity
