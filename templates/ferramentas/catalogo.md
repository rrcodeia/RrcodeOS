...
Referencia de APIs, CLIs e conectores que podem ser usados dentro de skills do Gemini Antigravity.
...
### Post for Me API
**O que faz:** Publica posts no Instagram e TikTok direto do Gemini Antigravity
...
**Precisa de conta:** Nao, ja vem no Gemini Antigravity
...
MCPs sao conectores que dao acesso direto a plataformas dentro do Gemini Antigravity.
O Gemini passa a usar esses conectores automaticamente quando fizer sentido.

Pra verificar quais MCPs ja estao instalados: `gemini mcp list`
Pra remover um MCP: `gemini mcp remove nome-do-mcp`
...
### Gmail
**O que faz:** Le e compoe emails sem sair do Gemini Antigravity
**Precisa de conta:** Sim, OAuth Google
**Como instalar:**
```bash
gemini mcp add gmail -- npx -y @gongrzhe/server-gmail-autoauth-mcp
```
...
**Como instalar:**
```bash
gemini mcp add google-calendar -- npx -y @gongrzhe/server-google-calendar-autoauth-mcp
```
**Quando usar:** Skills de agendamento, planejamento, organizacao de reunioes

### Canva
**O que faz:** Acessa designs, cria novos assets visuais direto pelo Gemini
**Precisa de conta:** Sim, Canva Pro
**Como instalar:**
```bash
gemini mcp add canva -- npx -y @canva/canva-mcp-server
```
...
**Como instalar:**
```bash
gemini mcp add n8n -- npx -y n8n-mcp
```
