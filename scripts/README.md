# scripts/ — utilitários do RrcodeOS
...
| `/analisar-dados` | `analisa_csv.py` | Utilitário Python para inspeção de arquivos CSV/XLSX |
| *(Manutenção / Auditoria)* | `validar_encoding.js` | Validação de UTF-8 estrito, integridade e ausência de BOM/mojibake |
...
## Como o RrcodeOS lida com isso

Quando você roda uma skill que precisa de script ausente, o Gemini vai:
